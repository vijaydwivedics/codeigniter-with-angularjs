                    ...
                    <table class="table table-responsive-sm table-hover table-outline mb-0">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img src="<?php echo base_url(); ?>/assets/images/avatars/2.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img src="<?php echo base_url(); ?>/assets/images/avatars/3.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img src="<?php echo base_url(); ?>/assets/images/avatars/4.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img src="<?php echo base_url(); ?>/assets/images/avatars/5.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
                              <span class="avatar-status badge-success"></span>
                            </div>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img src="<?php echo base_url(); ?>/assets/images/avatars/6.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
                              <span class="avatar-status badge-danger"></span>
                            </div>
                          </td>
                          <td>
