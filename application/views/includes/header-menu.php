	<header class="app-header navbar">
	  ...
	  <ul class="nav navbar-nav ml-auto">
		...
		<div class="list-group-item text-center p-b-20 ">
			<div class="avatar float-left">
			<img class="img-avatar" src="http://localhost/ci/cistore//assets/images/avatars/6.jpg" alt="admin@bootstrapmaster.com" />
			</div>
			<div>
			<strong>Lucas</strong>
			</div>
