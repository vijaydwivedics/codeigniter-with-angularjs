	    ...
	    success(function(data, status, headers, config) {
	    	...
	    	if(data.success){
	    		if( $scope.editMode ){
	    			...
	    			$scope.post.users[$scope.index].first_name = $scope.tempUser.firstname;
	    			$scope.post.users[$scope.index].last_name = $scope.tempUser.lastname;
	    			$scope.post.users[$scope.index].user_email = $scope.tempUser.email;
	    			$scope.post.users[$scope.index].company_name = $scope.tempUser.companyname;
	    			...
	    			$scope.post.users.push({
		    			id : data.id,
		    			first_name : $scope.tempUser.firstname,
		    			last_name : $scope.tempUser.lastname,
		    			user_email : $scope.tempUser.email,
		    			company_name : $scope.tempUser.companyname,
